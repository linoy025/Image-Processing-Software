...
public class LightsTests {
	...
	public void triangleLights() {
		...
		scene2.lights.add(new SpotLight(new Color(500, 250, 250), new Point3D(100, 100, 130), new Vector(-2, 2, 1)));
		scene2.lights.add(new PointLight(new Color(500, 250, 250), new Point3D(10, 10, 130)));
	...
	public void sphereLights() {
		...
		scene2.lights.add(new SpotLight(new Color(400, 200, 0), new Point3D(-50, 50, -50), new Vector(1, -1, 2)));
		scene2.lights.add(new PointLight(new Color(500, 300, 0), new Point3D(-50, 50, -50)));
		scene2.lights.add(new DirectionalLight(new Color(600, 400, 0), new Vector(1, -1, 1)));
